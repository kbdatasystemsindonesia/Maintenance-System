...
class CountryDetail extends Component {
  ...
  componentDidMount() {
    // const scriptChartArea = document.createElement("script");
    // const style = document.createElement("link");
    // scriptChartArea.src = "js/demo/chart-area-demo.js";
    // scriptChartArea.async = true;
    // document.body.appendChild(scriptChartArea);
    // const scriptChartPie = document.createElement("script");
    // scriptChartPie.src = "js/demo/chart-pie-demo.js";
    // scriptChartPie.async = true;
    // document.body.appendChild(scriptChartPie);
    // const scriptBarPie = document.createElement("script");
    // scriptBarPie.src = "js/demo/chart-bar-demo.js";
    // scriptBarPie.async = true;
    // document.body.appendChild(scriptBarPie);
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="card shadow mb-4">
                <h1 className="card-header p-1 col-12 text-white bg-shadow-dark ">Country Detail</h1>
