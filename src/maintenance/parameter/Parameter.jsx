                        ...
                        <div className="col-lg-12">
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-brown">Search</h6>
                                </div>
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row col-sm-12 bg-gray-100">
                                        <div className="col-md-6">
                                            <div className="form-group row">
                                                <label htmlFor="inputCode" className="col-sm-4 col-form-label margin-top-rem-1 label-bold label-mandatory">Parameter</label>
                                                <label className="col-sm-1 col-form-label margin-top-rem-1">:</label>
                                                <div className="col-sm-6 margin-top-rem-1">                                                    
                                                    <div className="mb-3">
                                                        <select className="form-control" id="exampleFormControlSelect2" multiple="">
                                    ...
                                    <div className="row col-sm-12 bg-ginger">
                                        <div className="col-md-6">
                                            <div className="form-group row">
                                                ...
                                                <label className="col-sm-1 col-form-label margin-top-rem-1 ">:</label>
                                                <input type="text" className="col-sm-6 form-control margin-top-rem-1" id="inputSearch" placeholder="Search..." />                                                
                                            </div>
                                        </div>
                                    ...
                                    <div className="row justify-content-center">
                                            <button type="button" className="btn parameter-searching-criteria float-right margin-top-rem-1 btn-min-width "><i><BsSearch></BsSearch></i></button>
                                       

                                        
                                            <button type="button" className="btn parameter-searching-criteria float-right margin-top-rem-1 btn-min-width ml-2" onClick={this.addOnClick}><i><BsPlusLg></BsPlusLg></i></button>
                            ...
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-brown">Listing</h6>
                                </div>
                                    ...
                                    <div className="table-responsive">
                                        <table className="table table-bordered" id="dataTable" width="100%" cellSpacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="/parameterDetail">Airi Satou</a></td>
                                                    <td>Accountant</td>
                                                    <td>Tokyo</td>
                                                    <td>33</td>
                                                    <td>2008/11/28</td>
