                        ...
                        <div className="col-lg-12">
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-warning">Add</h6>
                                </div>
                                ...
                                <div className="card-body">
                                    <form >
                                        ...
                                        <div className="row justify-content-center">
                                                ...
                                                <button type="submit" className="btn parameter-searching-criteria float-right margin-top-rem-1 btn-min-width mr-2" onClick={this.backOnClick}><i><BsPlusLg></BsPlusLg></i></button>
                            ...
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-warning">Language Mapping</h6>
                                </div>
                            ...
                            <div className="card shadow mb-4">
                                <div className="card-header py-3">
                                    <h6 className="m-0 font-weight-bold text-warning">Host Mapping</h6>
                                </div>
